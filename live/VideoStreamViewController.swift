...
class VideoStreamViewController: UIViewController, AVCaptureFileOutputRecordingDelegate {
    ...
    override func viewDidLoad() {
        ...
        dispatch_async(sessionQueue) {
            ...
            let videoDevice: AVCaptureDevice! = VideoStreamViewController.deviceWithMediaType(AVMediaTypeVideo, preferringPosition: AVCaptureDevicePosition.Back)
    ...
    override func viewWillAppear(animated: Bool) {
        dispatch_async(self.sessionQueue) {
            ...
            NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(VideoStreamViewController.subjectAreaDidChange(_:)), name: AVCaptureDeviceSubjectAreaDidChangeNotification, object: self.videoDeviceInput?.device)
    ...
    @IBAction func toggleMovieRecord(sender: AnyObject) {
        ...
        dispatch_async(self.sessionQueue) {
            if !self.movieFileOutput!.recording{
                ...
                VideoStreamViewController.setFlashMode(AVCaptureFlashMode.Off, device: self.videoDeviceInput!.device)
    ...
    @IBAction func snapStillImage(sender: AnyObject) {
        ...
        dispatch_async(self.sessionQueue) {
            ...
            VideoStreamViewController.setFlashMode(AVCaptureFlashMode.Auto, device: self.videoDeviceInput!.device)
    ...
    @IBAction func changeCamera(sender: AnyObject) {
        ...
        dispatch_async(self.sessionQueue) {
            ...
            guard let device:AVCaptureDevice! = VideoStreamViewController.deviceWithMediaType(AVMediaTypeVideo, preferringPosition: preferredPosition) else {
            ...
            if self.session!.canAddInput(videoDeviceInput) {
                ...
                VideoStreamViewController.setFlashMode(AVCaptureFlashMode.Auto, device: device!)
                
                NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(VideoStreamViewController.subjectAreaDidChange(_:)), name: AVCaptureDeviceSubjectAreaDidChangeNotification, object: device)
