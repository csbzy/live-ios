...
final public class RTMPMuxer {
    public weak var delegate:RTMPMuxerDelegate? = nil
...
extension RTMPMuxer: AudioEncoderDelegate {
    public func didSetFormatDescription(audio formatDescription: CMFormatDescriptionRef?) {
...
extension RTMPMuxer: VideoEncoderDelegate {
    ...
    public func didSetFormatDescription(video formatDescription: CMFormatDescriptionRef?) {
        guard let
